...
CREATE TABLE sms_request_statuses(
  ...
  status ENUM('SENT_TO_SERVER','DELIVERED_TO_SERVER','FAILED_TO_SEND_TO_SERVER','SENT_TO_RECIPIENT','DELIVERED_TO_RECIPIENT','FAILED_TO_SEND_TO_RECIPIENT','FAILED_TO_DELIVER_TO_RECIPIENT') NOT NULL DEFAULT 'SENT_TO_SERVER',
